...
namespace BikeStores.MSSQL.Migrations
{
    public partial class apiEF : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D35945C439", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D48D12E31F", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E6164A310B2FF",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
